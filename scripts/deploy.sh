...
GEMINI_DEFAULT_MODEL=${GEMINI_DEFAULT_MODEL:-gemini-3.1-pro-preview},\
...
GEMINI_SEARCH_MODEL=${GEMINI_SEARCH_MODEL:-gemini-3.5-flash},\
GEMINI_SEARCH_OUTPUT_TOKENS=${GEMINI_SEARCH_OUTPUT_TOKENS:-8192},\
SEARCH_BACKEND=${SEARCH_BACKEND:-bigquery},\
SEARCH_DISPLAY_MAX_DISTANCE=${SEARCH_DISPLAY_MAX_DISTANCE:-1.05},\
BT_INSTANCE=${BT_INSTANCE:-superover-search},\
BT_TABLE=${BT_TABLE:-scene_embeddings},\
...
AVATAR_LIVE_MODEL=${AVATAR_LIVE_MODEL:-gemini-3.1-flash-live-preview-04-2026},\
AVATAR_LIVE_PROJECT=${AVATAR_LIVE_PROJECT:-},\
AVATAR_LIVE_LOCATION=${AVATAR_LIVE_LOCATION:-global},\
AVATAR_LIVE_AUDIO_ONLY=${AVATAR_LIVE_AUDIO_ONLY:-false},\
AVATAR_LIVE_HOST_OVERRIDE=${AVATAR_LIVE_HOST_OVERRIDE:-},\
AVATAR_LIVE_DEBUG=${AVATAR_LIVE_DEBUG:-false}"
