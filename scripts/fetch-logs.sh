...
#                           e.g. 'textPayload:"Search pipeline latency"'
#   -s, --service NAME      Cloud Run service name (resource.labels.service_name).
#                           e.g. superover-frontend, superover-worker.
...
#
# Examples:
#   scripts/fetch-logs.sh -s superover-frontend -S ERROR -F 6h
#   scripts/fetch-logs.sh -s superover-frontend -f 'textPayload:"Search pipeline latency"' -F 30m
#   scripts/fetch-logs.sh -s superover-frontend -f 'textPayload:"avatar"' -F 20m -n 100
