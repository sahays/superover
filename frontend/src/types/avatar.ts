// Avatar live (Gemini Live) — types and the catalogs the create/edit UI binds to.
...
// are best-effort based on common name conventions (used for filtering only).
...
export interface AvatarLiveToken {
  token: string
  expires_at: string
}

// BCP-47 language codes Gemini Live officially supports.
