          ...
          <CardContent className="space-y-4">
            {executions.length > 0 ? (
              executions.map((execution) => (
                <div key={execution.id} className="flex items-center justify-between p-3 rounded-lg border">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-sm">{execution.pipelineName}</p>
                      <p className="text-xs text-gray-500">
                        {execution.sourceFileName} • {formatRelativeTime(execution.startedAt)}
                      </p>
                    </div>
                  </div>
                  <div className="text-xs">
              ...
              <div className="text-center py-6">
                ...
                <p className="mt-1 text-sm text-gray-500">Start processing your media files.</p>
                <div className="mt-6">
                  <Button asChild>
