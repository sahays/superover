...
import { X, Settings, Video, Layers } from 'lucide-react';
...
interface Pipeline {
  ...
  settings: {
    outputQuality: '360p' | '480p' | '720p' | '1080p';
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant="outline">Transcoder</Badge>
                </div>
                <div className="flex justify-between items-center">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-muted-foreground">Output Quality</span>
                  </div>
                  <Badge variant="outline">{pipeline.settings.outputQuality}</Badge>
                </div>
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    <Layers className="h-4 w-4 text-muted-foreground" />
                    <span className="text-sm text-muted-foreground">Multi-Quality Output</span>
                  </div>
                  <Badge variant="outline" className={
                    ...
                    {pipeline.settings.generateMultiple ? 'Enabled' : 'Disabled'}
                  </Badge>
                </div>
              </div>
            </div>
            ...
            {pipeline.settings.generateMultiple && (
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-sm text-blue-700">
                  <strong>Multi-Quality Configuration:</strong> This pipeline generates multiple quality versions (360p, 480p, and {pipeline.settings.outputQuality}) optimized for Indian network conditions with VMAF quality assessment.
                </p>
              </div>
            )}
