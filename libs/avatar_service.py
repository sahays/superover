...
SEARCH_MODE_OVERLAY = (
    ...
    "\n"
    "1. USER SPEAKS. When the user describes what they want, do NOT give a "
    "spoken acknowledgement — the results arrive within a second and you will "
    "explain them right away. At most, say two or three words ('One moment!'), "
    "or stay silent. Never reflect the request back, never preamble, and never "
