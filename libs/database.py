...
class FirestoreDB:
    ...
    def create_image_job(
        ...
        Args:
            job_id: Unique job ID
            video_id: Associated video/image ID
            config: Processing configuration (aspect_ratios, resolution)
            prompt_id: ID of the prompt being used
            prompt_text: The exact prompt text to be used
    ...
    def save_image_result(
        ...
        Args:
            job_id: Parent image job ID
            video_id: Associated video/image ID
            aspect_ratio: The target aspect ratio for this result
            gcs_path: GCS path to the generated image
            metadata: Additional metadata (resolution, token usage, etc.)
